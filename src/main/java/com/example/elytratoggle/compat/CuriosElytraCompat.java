...
public final class CuriosElytraCompat {
     ...
     * lets an elytra be worn as an accessory) is a usable elytra. Other accessories, like an
     * innertube-style item that grants its own flight, simply won't match and are ignored.
     */
